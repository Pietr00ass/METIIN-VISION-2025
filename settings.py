...
class ResourceName(Enum):
    ...
    WUKONG_PHOENIX_EGG = "jaja_feniksa"
    WUKONG_RESTART = "zacznij_dung"
    WUKONG_RESTART_CONFIRM = "zaakceptuj_dung"
    WUKONG_METIN = "metin"
    WUKONG_MOB = "moby"
    WUKONG_CRIMSON_GOURD = "karmazynowy_gurd"
    WUKONG_MONKEY_KING = "wukong"
    WUKONG_CLOUD_GUARDIAN = "obronca_chmur"
    WUKONG_FLAMING_PHOENIX = "plomienny_feniks"
